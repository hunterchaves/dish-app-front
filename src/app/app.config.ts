  ...
  { path: 'pedido/:id', component: OrderStatusComponent },
    { 
      ...
      children: [
        ...
        { path: 'motoboy', loadComponent: () => import('./components/motoboy-management/motoboy-management.component').then(m => m.MotoboyManagementComponent) },
        { path: 'delivered-orders', loadComponent: () => import('./components/delivered-orders/delivered-orders.component').then(m => m.DeliveredOrdersComponent) },
